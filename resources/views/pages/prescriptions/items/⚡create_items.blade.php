...
use App\Domains\Prescription\UseCases\PrescriptionItem\CreatePrescriptionItemUseCase;
use Livewire\Attributes\Layout;
use Livewire\Component;

new #[Layout('layouts.dashboard')] class extends Component
{
    protected CreatePrescriptionItemUseCase $createPrescriptionItemUseCase;
    ...
    public function boot(
        CreatePrescriptionItemUseCase $createPrescriptionItemUseCase
    ): void {
        $this->createPrescriptionItemUseCase = $createPrescriptionItemUseCase;
    }
    ...
    public function create()
    {
        ...
        try {
            ...
            $this->createPrescriptionItemUseCase->execute($dto);
    ...
    <div class="mb-8 flex items-center justify-between">
        ...
        <div>
            ...
            <p class="mt-2 text-slate-500">
                Add a medication to Prescription #{{ $prescription_id }}.
            </p>
        ...
        <div class="space-y-6">
            ...
            <div class="rounded-2xl border border-slate-200 bg-white shadow-sm">
                ...
                <div class="border-b border-slate-200 px-8 py-6">
                    ...
                    <p class="mt-1 text-sm text-slate-500">
                        Enter the medication and prescription instructions.
                    </p>
            ...
            <div class="rounded-2xl border border-slate-200 bg-white shadow-sm">
                ...
                <div class="border-b border-slate-200 px-8 py-6">
                    ...
                    <p class="mt-1 text-sm text-slate-500">
                        This medication will be added to the selected prescription.
                    </p>
