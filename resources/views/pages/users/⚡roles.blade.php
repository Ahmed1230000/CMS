...
new #[Layout('layouts.dashboard')] class extends Component
{
    ...
    */
    ...
    protected SyncUserRolesUseCase $syncUserRolesUseCase;
    ...
    */
    ...
    public function boot(
        ...
        SyncUserRolesUseCase $syncUserRolesUseCase
    ): void {
        $this->listRolesUseCase = $listRolesUseCase;

        $this->syncUserRolesUseCase = $syncUserRolesUseCase;
    }
    ...
    */
    ...
    public function assign(): void
    {
        ...
        $dto = SyncUserRolesDTO::fromArray([
            'user_id' => $data['user_id'],
            'roles' => $data['selectedRoles'],
        ]);

        $this->syncUserRolesUseCase->execute($dto);
