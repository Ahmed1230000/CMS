...
new #[Layout('layouts.dashboard')] class extends Component
{
    ...
    protected CreateHrUseCase $createHrUseCase;

    public function boot(
        CreateHrUseCase $createHrUseCase
    ): void {
    ...
    public function create()
    {
        ...
        try {
            ...
            $dto = HrDTO::fromArray($validation);

            $this->createHrUseCase->execute($dto);
            ...
            return $this->redirectRoute('hrs.index');
    ...
    <div class="mb-8 flex items-center justify-between">
        ...
        <div>
            ...
            <p class="mt-2 text-slate-500">
                Create a hospital HR account and profile.
            </p>
        ...
        <div class="space-y-6">
            ...
            <div class="rounded-2xl border border-slate-200 bg-white shadow-sm">
                ...
                <div class="border-b border-slate-200 px-8 py-6">
                    ...
                    <p class="mt-1 text-sm text-slate-500">
                        Enter the HR employee's personal and employment information.
                    </p>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="flex items-center justify-between rounded-xl border border-slate-200 p-4">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm text-slate-500">
                                    Allow this HR account to be active in the system.
                                </p>
